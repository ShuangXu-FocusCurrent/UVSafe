...
public class Q4Category2Fragment extends Fragment {
    private FragmentQ4Category2Binding binding;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        binding = FragmentQ4Category2Binding.inflate(getLayoutInflater());
        ...
        binding.buttonCat2Q1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_q4Category2Fragment_to_q1Category2Fragment);
            }
        });
        ...
        binding.buttonCat2Q2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_q4Category2Fragment_to_q2Category2Fragment);
            }
        });
        ...
        binding.buttonCat2Q3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_q4Category2Fragment_to_q3Category2Fragment);
            }
        });
