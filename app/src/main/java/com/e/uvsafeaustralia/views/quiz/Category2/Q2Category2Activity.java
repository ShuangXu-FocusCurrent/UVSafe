...
public class Q2Category2Activity extends AppCompatActivity {
    ...
    private AnswerModel userAnswerC2Q2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.buttonCat2Q2Active.setVisibility(View.VISIBLE);
        ...
        userAnswerC2Q2 = getUserAnswer(player, question);
        if (userAnswerC2Q2.getId() != 0) {
            String selected = userAnswerC2Q2.getSelected();
        ...
        binding.buttonOpt1Answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // record answer
                userAnswerC2Q2.setUser(player);
                userAnswerC2Q2.setQuestion(question);
                userAnswerC2Q2.setSelected(question.getAnswerOption1());
                userAnswerC2Q2.setStatus(0);
                recordAnswer(userAnswersCategory2, userAnswerC2Q2);
                disableAnswerOptions();
                showFeedback("wrong", question);
            }
        });
        ...
        binding.buttonOpt2Answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userAnswerC2Q2.setUser(player);
                userAnswerC2Q2.setQuestion(question);
                userAnswerC2Q2.setSelected(question.getAnswerOption2());
                userAnswerC2Q2.setStatus(0);
                recordAnswer(userAnswersCategory2, userAnswerC2Q2);
                disableAnswerOptions();
                showFeedback("wrong", question);
        ...
        binding.buttonOpt3Answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userAnswerC2Q2.setUser(player);
                userAnswerC2Q2.setQuestion(question);
                userAnswerC2Q2.setSelected(question.getAnswerOption3());
                userAnswerC2Q2.setStatus(1);
                recordAnswer(userAnswersCategory2, userAnswerC2Q2);
                disableAnswerOptions();
                showFeedback("right", question);
            }
        ...
        binding.buttonCat2Q1Incative.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Q2Category2Activity.this, Q1Category2Activity.class);
        ...
        binding.buttonCat2Q3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Q2Category2Activity.this, Q3Category2Activity.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        });
        ...
        binding.buttonCat2Q4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Q2Category2Activity.this, Q4Category2Activity.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        });
        ...
        binding.buttonCat2End.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Q2Category2Activity.this, "You'll be redirected to the Quiz Homepage. Thanks for attempting the quiz.", Toast.LENGTH_LONG).show();
                Intent intent = new Intent( Q2Category2Activity.this, QuizFourBlocksActivity.class);
                startActivity(intent);
            }
        });
