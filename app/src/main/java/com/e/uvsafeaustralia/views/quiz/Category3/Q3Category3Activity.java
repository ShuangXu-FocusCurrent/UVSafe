...
public class Q3Category3Activity extends AppCompatActivity {
    private ActivityQ1Category4Binding binding;
    private QuestionModel question;
    private AnswerModel userAnswerC3Q3;
...
//        binding.buttonCat4Q1Incative.setVisibility(View.VISIBLE);
        ...
        userAnswerC3Q3 = getUserAnswer(player, question);
        if (userAnswerC3Q3.getId() != 0) {
            String selected = userAnswerC3Q3.getSelected();
        ...
        binding.buttonOpt1Answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // record answer
                userAnswerC3Q3.setUser(player);
                userAnswerC3Q3.setQuestion(question);
                userAnswerC3Q3.setSelected(question.getAnswerOption1());
                userAnswerC3Q3.setStatus(0);
                recordAnswer(userAnswersCategory3, userAnswerC3Q3);
                disableAnswerOptions();
                showFeedback("wrong", question);
            }
        });
        ...
        binding.buttonOpt2Answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userAnswerC3Q3.setUser(player);
                userAnswerC3Q3.setQuestion(question);
                userAnswerC3Q3.setSelected(question.getAnswerOption2());
                userAnswerC3Q3.setStatus(1);
                recordAnswer(userAnswersCategory3, userAnswerC3Q3);
                disableAnswerOptions();
                showFeedback("right", question);
            }
        ...
        binding.buttonOpt3Answer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userAnswerC3Q3.setUser(player);
                userAnswerC3Q3.setQuestion(question);
                userAnswerC3Q3.setSelected(question.getAnswerOption3());
                userAnswerC3Q3.setStatus(0);
                recordAnswer(userAnswersCategory3, userAnswerC3Q3);
                disableAnswerOptions();
                showFeedback("wrong", question);
        ...
        binding.buttonCat4Q2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Q3Category3Activity.this, Q2Category3Activity.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        });
        ...
        binding.buttonCat4Q4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Q3Category3Activity.this, Q4Category3Activity.class);
                intent.putExtras(bundle);
                startActivity(intent);
            }
        });
        ...
        binding.buttonCat4End.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Q3Category3Activity.this, "You'll be redirected to the Quiz Homepage. Thanks for attempting the quiz.", Toast.LENGTH_LONG).show();
                Intent intent = new Intent( Q3Category3Activity.this, QuizFourBlocksActivity.class);
                startActivity(intent);
            }
        });
    }
