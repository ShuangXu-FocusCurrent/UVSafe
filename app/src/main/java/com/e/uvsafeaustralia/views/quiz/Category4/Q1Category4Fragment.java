...
public class Q1Category4Fragment extends Fragment {
    private FragmentQ1Category4Binding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                navController.navigate(R.id.action_q1Category4Fragment_to_q2Category4Fragment);
            }
        });
        ...
        binding.button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_q1Category4Fragment_to_q3Category4Fragment);
            }
        });
        ...
        binding.button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                navController.navigate(R.id.action_q1Category4Fragment_to_q4Category4Fragment);
            }
        });
